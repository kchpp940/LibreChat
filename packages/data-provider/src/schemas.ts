...
export const tModelCapabilitySchema = z.object({
  ...
  reasoning_effort: z.boolean().default(false),
  reasoning_format: eReasoningParameterFormatSchema.optional(),
  reasoning_key: eReasoningResponseKeySchema.optional(),
  supports_temperature: z.boolean().default(true),
  supports_top_p: z.boolean().default(true),
  supports_top_k: z.boolean().default(false),
  supports_frequency_penalty: z.boolean().default(false),
  supports_presence_penalty: z.boolean().default(false),
  supports_stop: z.boolean().default(false),
  supports_max_tokens: z.boolean().default(true),
  anthropic_thinking: z.boolean().default(false),
  anthropic_effort: z.boolean().default(false),
  google_thinking: z.boolean().default(false),
  prompt_caching: z.boolean().default(false),
  image_detail: z.boolean().default(false),
  resend_files: z.boolean().default(true),
  prompt_prefix: z.boolean().default(true),
});

export type TModelCapability = z.infer<typeof tModelCapabilitySchema>;

export const tModelInfoSchema = z.object({
  model: z.string(),
  label: z.string().optional(),
  capabilities: tModelCapabilitySchema,
});

export type TModelInfo = z.infer<typeof tModelInfoSchema>;
