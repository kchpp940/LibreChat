...
describe('ConversationTag Utilities', () => {
    ...
    describe('updateConversationTag', () => {
        it('updates the first tag correctly', () => {
            const updated = updateConversationTag(conversations, { tag: 'tag1-new', description: 'description1-new' }, {
                ...conversations[1],
                tag: 'tag1-new',
    ...
    it('updates the third tag correctly', () => {
        const updated = updateConversationTag(conversations, { tag: 'tag3-new', description: 'description3-new' }, {
            ...conversations[3],
            tag: 'tag3-new',
    ...
    it('updates the order of other tags if the order of the tags is moving up', () => {
        const updated = updateConversationTag(conversations, 
    ...
    it('updates the order of other tags if new tag is added', () => {
        const updated = updateConversationTag(conversations, { tag: 'newtag', description: 'newDescription' }, {
            _id: 'tag-id-newtag',
            tag: 'newtag',
    ...
    it('returns a new array for new tag if no tags exist', () => {
        const updated = updateConversationTag([], { tag: 'newtag', description: 'newDescription' }, {
            _id: 'tag-id-saved',
            tag: 'saved',
            description: 'newDescription',
            position: 0,
