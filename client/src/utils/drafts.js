...
export const clearDraft = debounce((id) => {
...
export const clearAllDrafts = (conversationId) => {
...
export const setDraft = ({ id, value }) => {
...
export const getDraft = (id) => decodeBase64((localStorage.getItem(`${LocalStorageKeys.TEXT_DRAFT}${id ?? ''}`) ?? '') || '');
