 ...
 */
export function supportsClientResize() {
    try {
        ...
        return (ctx != null && typeof ctx.drawImage === 'function' && typeof canvas.toBlob === 'function');
    }
    catch {
        return false;
    }
        ...
        reader.onload = (event) => {
            ...
            img.onload = () => {
                try {
                    ...
                    const newDimensions = calculateDimensions(img.width, img.height, opts.maxWidth, opts.maxHeight);
 ...
 */
export function shouldResizeImage(file, fileSizeLimit = 512 * 1024 * 1024) {
