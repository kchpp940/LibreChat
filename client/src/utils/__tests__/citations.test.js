import { SPAN_REGEX, COMPOSITE_REGEX, STANDALONE_PATTERN, CLEANUP_REGEX, INVALID_CITATION_REGEX, } from '../citations';
describe('Citation Regex Patterns', () => {
    ...
    describe('Integration: Full Citation Processing Flow', () => {
         ...
         */
        const processFullCitationFlow = (text) => {
            ...
            while ((standMatch = standRegex.exec(text)) !== null) {
                ...
                const isInComposite = composites.some((c) => standMatch && standMatch.index >= c.position && standMatch.index < c.position + 50);
                if (!isInComposite) {
                    standalones.push({
...
Composite with mixed: \\ue200\\ue202turn0file0\ue202turn0file1\\ue201`;
    ...
    describe('Performance: Regex Benchmarks', () => {
         ...
         */
        const generateCitationHeavyText = (citationCount, format) => {
