...
const hasHEICMetadata = (file) => HEIC_MIME_TYPES.has(file.type.toLowerCase()) || HEIC_EXTENSION_REGEX.test(file.name);
/**
 ...
 */
export const convertHEICToJPEG = async (file, quality = 0.9, onProgress) => {
    try {
 ...
 */
export const processFileForUpload = async (file, quality = 0.9, onProgress) => {
