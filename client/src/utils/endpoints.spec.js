...
describe('getEndpointField', () => {
    ...
    it('returns the correct value for a valid endpoint and property', () => {
        ...
        expect(getEndpointField(mockEndpointsConfig, EModelEndpoint.google, 'iconURL')).toEqual('google_icon.png');
    });
    it('returns undefined for a valid endpoint but an invalid property', () => {
        ...
        expect(getEndpointField(mockEndpointsConfig, EModelEndpoint.openAI, 'nonexistentProperty')).toBeUndefined();
    });
    ...
    it('returns undefined for a non-enum endpoint with an invalid property', () => {
        expect(getEndpointField(mockEndpointsConfig, 'Mistral', 'nonexistentProperty')).toBeUndefined();
    });
});
