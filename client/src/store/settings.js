...
const staticAtoms = {
    abortScroll: atom({ key: 'abortScroll', default: false }),
    optionSettings: atom({ key: 'optionSettings', default: {} }),
    currentSettingsView: atom({
        key: 'currentSettingsView',
        default: SettingsViews.default,
    }),
    showPopover: atom({ key: 'showPopover', default: false }),
};
const localStorageAtoms = {
    // General settings
    autoScroll: atomWithLocalStorage('autoScroll', false),
    sidebarExpanded: atomWithLocalStorage('unifiedSidebarExpanded', typeof window !== 'undefined' && window.matchMedia('(max-width: 768px)').matches ? false : true),
    enableUserMsgMarkdown: atomWithLocalStorage(LocalStorageKeys.ENABLE_USER_MSG_MARKDOWN, true),
    ...
    voice: atomWithLocalStorage('voice', undefined),
    ...
    playbackRate: atomWithLocalStorage('playbackRate', null),
