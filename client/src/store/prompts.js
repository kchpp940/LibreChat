...
const staticAtoms = {
    // `name` filter
    promptsName: atom({ key: 'promptsName', default: '' }),
    // `category` filter
    promptsCategory: atom({ key: 'promptsCategory', default: '' }),
    // `pageNumber` filter
    promptsPageNumber: atom({ key: 'promptsPageNumber', default: 1 }),
    // `pageSize` filter
    promptsPageSize: atom({ key: 'promptsPageSize', default: 10 }),
};
