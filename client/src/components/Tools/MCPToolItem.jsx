...
function MCPToolItem({ tool, onAddTool, onRemoveTool, isInstalled = false, isConfiguring = false, isInitializing = false, }) {
    ...
    return (<div className="flex flex-col gap-4 rounded border border-border-medium bg-transparent p-6">
      <div className="flex gap-4">
        ...
        <div className="flex min-w-0 flex-col items-start justify-between">
          ...
          <button className={buttonState.className} aria-label={`${buttonState.text} ${name}`} onClick={handleClick} disabled={buttonState.disabled}>
