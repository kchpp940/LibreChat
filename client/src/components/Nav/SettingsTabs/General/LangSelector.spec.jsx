...
describe('LangSelector', () => {
    ...
    it('renders correctly', () => {
        ...
        const { getByText, getByRole } = render(<RecoilRoot>
    ...
    it('calls onChange when the select value changes', async () => {
        ...
        const { getByRole, getByTestId } = render(<RecoilRoot>
        <LangSelector langcode="en-US" onChange={mockOnChange}/>
      </RecoilRoot>);
    ...
    it('shows a loading indicator while language resources load', () => {
        ...
        const { getByRole } = render(<RecoilRoot initializeState={({ set }) => set(store.languageLoading, true)}>
        <LangSelector langcode="en-US" onChange={mockOnChange}/>
      </RecoilRoot>);
