...
export default function SaveDraft({ onCheckedChange, }) {
    ...
    return (<div className="flex items-center justify-between">
      ...
      <Switch id="showThinking" checked={showThinking} onCheckedChange={handleCheckedChange} className="ml-4" data-testid="showThinking" aria-label={localize('com_nav_show_thinking')}/>
    </div>);
}
