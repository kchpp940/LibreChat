...
function ImportConversations() {
    ...
    const handleError = useCallback((error) => {
        ...
        showToast({
            message: localize(isUnsupportedType
    ...
    return (<div className="flex items-center justify-between">
      ...
      <Button variant="outline" onClick={handleImportClick} onKeyDown={handleKeyDown} disabled={isImportDisabled} aria-label={localize('com_ui_import')} aria-labelledby="import-conversation-label">
        {isUploading ? (<>
      ...
      <input ref={fileInputRef} type="file" className={cn('hidden')} accept=".json" onChange={handleFileChange} aria-hidden="true"/>
    </div>);
}
