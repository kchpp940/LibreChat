...
import { OGDialogTemplate, Label, Button, OGDialog, OGDialogTrigger, Spinner, } from '@librechat/client';
    ...
    return (<div className="flex items-center justify-between">
      ...
      <OGDialog open={open} onOpenChange={setOpen}>
        <OGDialogTrigger asChild>
          <Button aria-labelledby="clear-all-chats-label" variant="destructive" onClick={() => setOpen(true)}>
            {localize('com_ui_delete')}
          </Button>
        </OGDialogTrigger>
        <OGDialogTemplate showCloseButton={false} title={localize('com_nav_confirm_clear')} className="max-w-[450px]" main={<Label className="break-words">
