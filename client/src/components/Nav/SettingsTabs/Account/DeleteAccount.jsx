...
import { InputOTPSeparator, OGDialogContent, OGDialogTrigger, OGDialogHeader, InputOTPGroup, OGDialogTitle, InputOTPSlot, OGDialog, InputOTP, Spinner, Button, Label, Input, } from '@librechat/client';
...
const DeleteAccount = ({ disabled = false }) => {
    ...
    const handleInputChange = useCallback((newEmailInput) => {
      ...
      <OGDialog open={isDialogOpen} onOpenChange={setDialogOpen}>
        <div className="flex items-center justify-between">
          ...
          <OGDialogTrigger asChild>
            <Button aria-labelledby="delete-account-label" variant="destructive" onClick={() => setDialogOpen(true)} disabled={disabled}>
        ...
        <OGDialogContent className="w-11/12 max-w-md">
          ...
          <div className="flex-col items-center justify-center">
            ...
            {needs2FA && (<div className="mb-4 space-y-3">
...
const renderInput = (label, id, value, onChange) => (<div className="mb-4">
...
const renderDeleteButton = (handleDeleteUser, isDeleting, isLocked, localize) => (<button className={cn('mt-4 flex w-full items-center justify-center rounded-lg bg-surface-tertiary px-4 py-2 transition-all duration-200', isLocked ? 'cursor-not-allowed opacity-30' : 'bg-destructive text-destructive-foreground')} onClick={handleDeleteUser} disabled={isDeleting || isLocked}>
    {isDeleting ? (<div className="flex h-6 justify-center">
