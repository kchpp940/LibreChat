...
export default function DisplayUsernameMessages() {
    ...
    return (<div className="flex items-center justify-between">
      ...
      <Switch id="UsernameDisplay" checked={UsernameDisplay} onCheckedChange={handleCheckedChange} className="ml-4" data-testid="UsernameDisplay" aria-labelledby="user-name-display-label"/>
    </div>);
}
