...
export default function LanguageSTTDropdown() {
    ...
    return (<div className="flex items-center justify-between">
      ...
      <Dropdown value={languageSTT} onChange={handleSelect} options={languageOptions} sizeClasses="[--anchor-max-height:256px]" testId="LanguageSTTDropdown" className="z-50" aria-labelledby={labelId}/>
    </div>);
}
