...
const EngineSTTDropdown = ({ external }) => {
    ...
    return (<div className="flex items-center justify-between">
      ...
      <Dropdown value={engineSTT} onChange={handleSelect} options={endpointOptions} sizeClasses="w-[180px]" testId="EngineSTTDropdown" className="z-50" aria-labelledby={labelId}/>
    </div>);
};
