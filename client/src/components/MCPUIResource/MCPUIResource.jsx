...
export function MCPUIResource(props) {
    ...
    if (!uiResource) {
        return (<span className="inline-flex items-center rounded bg-gray-100 px-2 py-1 text-xs font-medium text-gray-600">
    ...
    try {
        return (<span className="mx-1 inline-block w-full align-middle">
        ...
        return (<span className="inline-flex items-center rounded bg-red-50 px-2 py-1 text-xs font-medium text-red-600">
