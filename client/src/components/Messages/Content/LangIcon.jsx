...
const LangIcon = React.memo(function LangIcon({ lang, className }) {
    ...
    return (<svg role="img" viewBox="0 0 24 24" className={className} fill="currentColor" aria-hidden="true">
      <path d={path}/>
    </svg>);
});
