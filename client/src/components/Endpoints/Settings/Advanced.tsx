...
import type { TModelCapability } from 'librechat-data-provider';
import {
  Input,
  Label,
  Switch,
...
import { useLocalize, useDebouncedInput, useModelCapability } from '~/hooks';
  ...
  return (
    <div className="grid grid-cols-5 gap-6">
      <div className="col-span-5 flex flex-col items-center justify-start gap-6 sm:col-span-3">
        ...
        {(capability == null || capability.prompt_prefix) && (
          <div className="grid w-full items-center gap-2">
      ...
      <div className="col-span-5 flex flex-col items-center justify-start gap-6 px-3 sm:col-span-2">
        {(capability == null || capability.supports_temperature) && (
        ...
        {(capability == null || capability.supports_top_p) && (
          <HoverCard openDelay={300}>
            <HoverCardTrigger className="grid w-full items-center gap-2">
              <div className="flex justify-between">
        ...
        {(capability == null || capability.supports_frequency_penalty) && (
          <HoverCard openDelay={300}>
            <HoverCardTrigger className="grid w-full items-center gap-2">
              <div className="flex justify-between">
        ...
        {(capability == null || capability.supports_presence_penalty) && (
          <HoverCard openDelay={300}>
            <HoverCardTrigger className="grid w-full items-center gap-2">
              <div className="flex justify-between">
        ...
        {(capability == null || capability.resend_files || capability.image_detail) && (
          <div className="w-full">
            <div className="mb-2 flex w-full justify-between gap-2">
              {(capability == null || capability.resend_files) && (
                <label
              ...
              {(capability == null || capability.image_detail) && (
                <label
