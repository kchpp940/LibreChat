...
const tempVectorStoresAttached = [
...
export default function FilePreview() {
    ...
    return (<div className="m-3 bg-white p-2 sm:p-4 md:p-6 lg:p-10">
      ...
      <div className="mt-10 flex flex-col">
        ...
        <div className="flex flex-col divide-y">
          ...
          <div>
            {vectorStoresAttached.map((vectors, index) => (<div key={index} className="mt-2 flex flex-row">
                ...
                <div className="flex w-3/5 flex-row md:w-1/2 xl:w-1/3">
                  ...
                  <Button className="m-0 ml-3 h-full bg-transparent p-0 text-[#666666] hover:bg-slate-200" onClick={() => {
      ...
      <div className="mt-10 flex flex-col">
        <div className="flex flex-col divide-y">
          ...
          <div>
            {threads.map((thread, index) => (<div key={index} className="mt-2 flex flex-row">
