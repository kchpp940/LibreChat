...
export default function VectorStoreListItem({ vectorStore, deleteVectorStore, }) {
    ...
    return (<div onClick={() => {
      ...
      <div className="flex w-1/6 flex-col justify-around sm:flex-row">
        ...
        <Button className="m-0 w-full bg-transparent p-0 text-[#666666] hover:bg-slate-200 sm:w-fit" onClick={() => deleteVectorStore(vectorStore._id)}>
