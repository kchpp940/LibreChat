...
export default function VectorStorePreview() {
    ...
    return (<div className="m-3 ml-1 mr-7 bg-white p-2 sm:p-4 md:p-6 lg:p-10">
      ...
      <div className="mt-10 flex flex-col">
        ...
        <div className="flex flex-col divide-y">
          ...
          <div>
            {filesAttached.map((file, index) => (<div key={index} className="my-2 flex h-5 flex-row">
                ...
                <div className="flex w-1/2 flex-row lg:w-1/3">
                  ...
                  <Button className="my-0 ml-3 h-min bg-transparent p-0 text-[#666666] hover:bg-slate-200" onClick={() => console.log('click')}>
      ...
      <div className="mt-10 flex flex-col">
        ...
        <div className="flex flex-col divide-y">
          ...
          <div>
            {assistants.map((assistant, index) => (<div key={index} className="flex flex-row">
