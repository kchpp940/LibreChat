...
jest.mock('@librechat/client', () => {
    ...
    return {
        TooltipAnchor: ({ children, render, }) => R.cloneElement(render, {}, ...(Array.isArray(children) ? children : [children])),
        MCPIcon: ({ className }) => R.createElement('span', { className }),
        Spinner: ({ className }) => R.createElement('span', { className }),
    };
});
...
describe('MCPSelect', () => {
    ...
    it('closes menu on Escape', async () => {
        ...
        expect(screen.getByRole('button', { name: /MCP Servers/i })).toHaveAttribute('aria-expanded', 'false');
    });
