...
describe('DragDropModal - Provider Detection', () => {
    describe('endpointType priority over currentProvider', () => {
        it('should show upload option for LiteLLM with OpenAI endpointType', () => {
            ...
            const withFix = isDocumentSupportedProvider(endpointType) || isDocumentSupportedProvider(currentProvider);
        ...
        it('should show upload option for any custom gateway with OpenAI endpointType', () => {
            ...
            const result = isDocumentSupportedProvider(endpointType) || isDocumentSupportedProvider(currentProvider);
    ...
    describe('real-world scenarios', () => {
        it('should handle LiteLLM gateway pointing to OpenAI', () => {
            ...
            expect(isDocumentSupportedProvider(scenario.endpointType) ||
                isDocumentSupportedProvider(scenario.currentProvider)).toBe(true);
        });
        ...
        it('should handle unsupported custom endpoint without override', () => {
            ...
            expect(isDocumentSupportedProvider(scenario.endpointType) ||
                isDocumentSupportedProvider(scenario.currentProvider)).toBe(false);
        });
        ...
        it('should handle Azure OpenAI endpointType when Responses API is enabled', () => {
            ...
            const isAzureWithResponsesApi = (scenario.currentProvider === EModelEndpoint.azureOpenAI ||
            ...
            expect(isDocumentSupportedProvider(scenario.endpointType) ||
                ...
                isAzureWithResponsesApi).toBe(true);
        });
    });
