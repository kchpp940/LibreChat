...
const Image = ({ imageBase64, url, onDelete, progress = 1, source = FileSources.local, }) => {
    return (<div className="group relative inline-block text-sm text-black/70 dark:text-white/90">
