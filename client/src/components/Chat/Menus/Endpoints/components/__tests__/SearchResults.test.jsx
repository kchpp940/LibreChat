...
const agentsMarketplaceEndpoint = {
    value: 'agents',
    label: 'My Agents',
    hasModels: true,
    models: [{ name: 'agent-1' }],
...
describe('SearchResults', () => {
    ...
    it('marks model as selected when endpoint and model match with no active spec', () => {
        ...
        render(<SearchResults results={[anthropicEndpoint]} localize={localize} searchValue="claude"/>);
    ...
    it('renders Marketplace from agent endpoint search results and navigates to agents', () => {
        ...
        render(<SearchResults results={[agentsMarketplaceEndpoint]} localize={localize} searchValue="marketplace"/>);
    ...
    it('does not render agents as a selectable endpoint when marketplace and agent rows are unavailable', () => {
        mockSelectedValues = { endpoint: '', model: '', modelSpec: '' };
        render(<SearchResults results={[disabledAgentsEndpoint]} localize={localize} searchValue="my agents"/>);
