...
const MinimalMessages = React.forwardRef((props, ref) => {
    return (<div className={cn('relative flex w-full grow overflow-hidden bg-white dark:bg-gray-800', props.className)}>
