 ...
 */
const MarkdownBlock = memo(function MarkdownBlock({ content, codeBaseIndex, artifactBaseIndex, remarkPlugins, rehypePlugins, components, }) {
    return (<ArtifactProvider baseIndex={artifactBaseIndex}>
 ...
 */
const MarkdownBlocks = memo(function MarkdownBlocks({ content, remarkPlugins, rehypePlugins, components, }) {
    ...
    return (<>
      {blocks.map((block, index) => (
        ...
        <MarkdownBlock key={`${index}-${block.codeBaseIndex}-${block.artifactBaseIndex}`} content={block.raw} codeBaseIndex={block.codeBaseIndex} artifactBaseIndex={block.artifactBaseIndex} remarkPlugins={remarkPlugins} rehypePlugins={rehypePlugins} components={components}/>))}
    </>);
});
