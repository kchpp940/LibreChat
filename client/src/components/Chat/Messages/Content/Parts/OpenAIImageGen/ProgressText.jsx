...
export default function ProgressText({ progress, error, toolName = '', }) {
    ...
    const text = getText();
    return (<span className={cn('progress-text-content tool-status-text whitespace-nowrap font-medium', progress < 1 && 'shimmer')}>
      {text}
    </span>);
}
