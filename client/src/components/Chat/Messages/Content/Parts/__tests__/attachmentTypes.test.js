import { artifactTypeForAttachment, attachmentSalience, displayFilename, isImageAttachment, isInternalSandboxArtifact, isTextAttachment, } from '../attachmentTypes';
...
describe('isImageAttachment', () => {
    ...
    it('returns false when filename is missing', () => {
        const attachment = baseAttachment({ filename: undefined });
...
describe('attachmentSalience', () => {
    ...
    it('produces a stable bucket sort when used as `(a,b) => salience(a) - salience(b)`', () => {
        ...
        const sorted = [placeholder, real].sort((a, b) => attachmentSalience(a) - attachmentSalience(b));
