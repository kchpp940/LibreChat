...
jest.mock('../LogLink', () => ({
    __esModule: true,
    default: ({ href, filename, children, }) => (<a data-testid="log-link" href={href} data-filename={filename}>
      {children}
    </a>),
...
describe('LogContent attachment routing', () => {
    ...
    it('splits a mixed list into the right buckets', () => {
        ...
        const { container } = renderWith(<LogContent output="" attachments={attachments} renderImages={true}/>);
