...
test('renders login form', () => {
    const { getByLabelText } = render(<Login onSubmit={mockLogin} startupConfig={mockStartupConfig} error={undefined} setError={jest.fn()}/>);
...
test('displays validation error messages', async () => {
    const { getByLabelText, getByText } = render(<Login onSubmit={mockLogin} startupConfig={mockStartupConfig} error={undefined} setError={jest.fn()}/>);
    const emailInput = getByLabelText(/email/i);
    const passwordInput = getByLabelText(/password/i);
    const submitButton = getByTestId(document.body, 'login-button');
