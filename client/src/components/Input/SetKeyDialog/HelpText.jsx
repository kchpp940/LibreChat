...
function HelpText({ endpoint }) {
    ...
    const textMap = {
        ...
        <small className="mt-4 break-all text-text-secondary">
          ...
          <a target="_blank" href="https://console.cloud.google.com/vertex-ai" rel="noreferrer" className="text-blue-700 underline dark:text-blue-400">
            {localize('com_endpoint_config_key_google_vertex_ai')}
          </a>{' '}
          {localize('com_endpoint_config_key_google_vertex_api')}{' '}
          <a target="_blank" href="https://console.cloud.google.com/projectselector/iam-admin/serviceaccounts/create?walkthrough_id=iam--create-service-account#step_index=1" rel="noreferrer" className="text-blue-700 underline dark:text-blue-400">
        ...
        <small className="break-all text-text-secondary">
          ...
          <a target="_blank" href="https://makersuite.google.com/app/apikey" rel="noreferrer" className="text-blue-700 underline dark:text-blue-400">
