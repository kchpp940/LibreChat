...
function renderWithProviders(children, searchResults) {
    return render(<SearchContext.Provider value={{ searchResults }}>
...
describe('Citation', () => {
    it('renders composite file citations as buttons and opens the preview dialog', () => {
        ...
        renderWithProviders(<CompositeCitation node={{
                properties: {
                    citationId: 'cite-1',
    ...
    it('keeps standalone web citations as links', () => {
        ...
        renderWithProviders(<Citation citationId="cite-2" citationType="standalone" node={{
                properties: {
