...
export default function PrincipalAvatar({ principal, size = 'md', className, }) {
    ...
    if (avatar) {
        return (<div className={cn('flex-shrink-0', className)}>
        <img src={avatar} alt={`${displayName} avatar`} className={cn(avatarSizeClass, 'rounded-full object-cover')} onError={(e) => {
        ...
        <div className={cn('hidden', avatarSizeClass)}>
          <div className={cn(avatarSizeClass, 'flex items-center justify-center rounded-full', containerClass)}>
