...
describe('CategoryTabs', () => {
    ...
    it('renders provided categories', () => {
        render(<CategoryTabs categories={mockCategories} activeTab="promoted" isLoading={false} onChange={mockOnChange}/>);
    ...
    it('handles loading state properly', () => {
        render(<CategoryTabs categories={[]} activeTab="promoted" isLoading={true} onChange={mockOnChange}/>);
    ...
    it('highlights the active tab', () => {
        render(<CategoryTabs categories={mockCategories} activeTab="general" isLoading={false} onChange={mockOnChange}/>);
    ...
    it('shows empty state when categories prop is empty', () => {
        render(<CategoryTabs categories={[]} activeTab="promoted" isLoading={false} onChange={mockOnChange}/>);
