...
describe('SmartLoader', () => {
    ...
    const ContentComponent = () => (<div data-testid="content">
    ...
    describe('Basic functionality', () => {
        it('shows content immediately when not loading', () => {
            render(<SmartLoader isLoading={false} hasData={true} loadingComponent={<LoadingComponent />}>
          <ContentComponent />
        </SmartLoader>);
        ...
        it('shows content immediately when loading but has existing data', () => {
            render(<SmartLoader isLoading={true} hasData={true} loadingComponent={<LoadingComponent />}>
          <ContentComponent />
        </SmartLoader>);
            expect(screen.getByTestId('content')).toBeInTheDocument();
            expect(screen.queryByTestId('loading')).not.toBeInTheDocument();
        ...
        it('shows content initially, then loading after delay when loading with no data', async () => {
            render(<SmartLoader isLoading={true} hasData={false} delay={150} loadingComponent={<LoadingComponent />}>
          <ContentComponent />
        </SmartLoader>);
        ...
        it('prevents loading flash for quick responses', async () => {
            const { rerender } = render(<SmartLoader isLoading={true} hasData={false} delay={150} loadingComponent={<LoadingComponent />}>
          <ContentComponent />
        </SmartLoader>);
            // Initially shows content
            expect(screen.getByTestId('content')).toBeInTheDocument();
            ...
            rerender(<SmartLoader isLoading={false} hasData={true} delay={150} loadingComponent={<LoadingComponent />}>
          <ContentComponent />
        </SmartLoader>);
    ...
    describe('Delay behavior', () => {
        it('respects custom delay times', async () => {
            render(<SmartLoader isLoading={true} hasData={false} delay={300} loadingComponent={<LoadingComponent />}>
          <ContentComponent />
        </SmartLoader>);
        ...
        it('uses default delay when not specified', async () => {
            render(<SmartLoader isLoading={true} hasData={false} loadingComponent={<LoadingComponent />}>
          <ContentComponent />
        </SmartLoader>);
            // Should show content initially
            expect(screen.getByTestId('content')).toBeInTheDocument();
    ...
    describe('State transitions', () => {
        it('immediately hides loading when loading completes', async () => {
            const { rerender } = render(<SmartLoader isLoading={true} hasData={false} delay={100} loadingComponent={<LoadingComponent />}>
          <ContentComponent />
        </SmartLoader>);
            ...
            // Loading completes
            rerender(<SmartLoader isLoading={false} hasData={true} delay={100} loadingComponent={<LoadingComponent />}>
          <ContentComponent />
        </SmartLoader>);
        ...
        it('handles rapid loading state changes correctly', async () => {
          ...
          <ContentComponent />
            ...
            rerender(<SmartLoader isLoading={true} hasData={false} delay={100} loadingComponent={<LoadingComponent />}>
          <ContentComponent />
        </SmartLoader>);
    ...
    describe('CSS classes', () => {
        it('applies custom className', () => {
            const { container } = render(<SmartLoader isLoading={false} hasData={true} loadingComponent={<LoadingComponent />} className="custom-class">
          <ContentComponent />
        </SmartLoader>);
        ...
        it('applies className to both loading and content states', async () => {
            const { container } = render(<SmartLoader isLoading={true} hasData={false} delay={50} loadingComponent={<LoadingComponent />} className="custom-class">
          <ContentComponent />
        </SmartLoader>);
            // Content state
