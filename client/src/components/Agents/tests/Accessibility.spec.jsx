...
jest.mock('../SmartLoader', () => ({
    SmartLoader: ({ children, isLoading }) => (isLoading ? <div>Loading...</div> : children),
...
describe('Accessibility Improvements', () => {
    ...
    describe('CategoryTabs Accessibility', () => {
        ...
        it('implements proper tablist role and ARIA attributes', () => {
            render(<CategoryTabs categories={categories} activeTab="promoted" isLoading={false} onChange={jest.fn()}/>);
            // Check tablist role
        ...
        it('supports keyboard navigation', () => {
            ...
            render(<CategoryTabs categories={categories} activeTab="promoted" isLoading={false} onChange={onChange}/>);
    ...
    describe('SearchBar Accessibility', () => {
        it('provides proper search role and labels', () => {
            ...
            expect(searchInput).toHaveAttribute('aria-describedby', 'search-instructions search-results-count');
    ...
    describe('AgentCard Accessibility', () => {
        ...
        it('provides comprehensive ARIA labels', () => {
            ...
            render(<Wrapper>
          <AgentCard agent={mockAgent} onSelect={jest.fn()}/>
        </Wrapper>);
    ...
    describe('Focus Management', () => {
        ...
        it('provides visible focus indicators on interactive elements', () => {
            render(<CategoryTabs categories={[{ value: 'test', label: 'Test', count: 1 }]} activeTab="test" isLoading={false} onChange={jest.fn()}/>);
