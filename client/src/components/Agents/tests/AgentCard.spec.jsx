...
jest.mock('~/hooks/useLocalize', () => () => (key) => {
...
jest.mock('@librechat/client', () => {
    ...
    return {
        ...
        OGDialog: ({ children, open, onOpenChange }) => {
            // Store onOpenChange in context for trigger to call
            return (<div data-testid="dialog-wrapper" data-open={open}>
        ...
        OGDialogTrigger: ({ children, asChild, onOpenChange }) => {
...
describe('AgentCard', () => {
    ...
    it('displays avatar when provided as string', () => {
        const agentWithStringAvatar = {
            ...mockAgent,
            avatar: '/string-avatar.png', // Legacy support for string avatars
        };
        render(<Wrapper>
    ...
    it('displays Feather icon fallback when no avatar is provided', () => {
        ...
        render(<Wrapper>
        <AgentCard agent={agentWithoutAvatar} onSelect={mockOnSelect}/>
      </Wrapper>);
    ...
    it('has proper accessibility attributes', () => {
        ...
        expect(card).toHaveAttribute('aria-label', 'Test Agent agent. A test agent for testing purposes');
    });
