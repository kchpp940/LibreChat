...
export default function ActionsInput({ action, agent_id, setAction, }) {
    ...
    return (<>
      <div className="flex min-h-0 flex-1 flex-col">
        <div className="mb-1 flex flex-wrap items-center justify-between gap-4">
          <label htmlFor="schemaInput" className="text-token-text-primary whitespace-nowrap text-sm font-medium">
        ...
        <div className="border-token-border-medium bg-token-surface-primary hover:border-token-border-hover mb-4 flex min-h-0 flex-1 flex-col overflow-hidden rounded-lg border ring-0">
          <div className="relative flex min-h-0 flex-1 flex-col">
            <textarea id="schemaInput" value={inputValue} onChange={handleInputChange} spellCheck="false" placeholder={localize('com_ui_enter_openapi_schema')} className="text-token-text-primary block min-h-[12rem] flex-1 resize-y bg-transparent p-2 font-mono text-xs outline-none focus:ring-1 focus:ring-border-light"/>
          </div>
