...
const AdminSettings = () => {
    ...
    return (<AdminSettingsDialog permissionType={PermissionTypes.AGENTS} sectionKey="com_ui_agents" permissions={permissions} menuId="agent-role-dropdown" mutation={mutation}/>);
};
