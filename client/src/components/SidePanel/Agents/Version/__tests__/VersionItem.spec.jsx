...
describe('VersionItem', () => {
    ...
    test('handles invalid timestamp', () => {
        render(<VersionItem {...defaultProps} version={{ ...mockVersion, updatedAt: 'invalid-date' }}/>);
        expect(screen.getByText('Unknown date')).toBeInTheDocument();
    });
    test('handles missing timestamps', () => {
        render(<VersionItem {...defaultProps} version={{ ...mockVersion, updatedAt: undefined, createdAt: undefined }}/>);
