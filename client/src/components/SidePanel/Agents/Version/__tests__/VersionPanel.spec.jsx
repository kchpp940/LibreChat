...
describe('VersionPanel', () => {
    ...
    const mockUseAgentPanelContext = jest.requireMock('~/Providers/AgentPanelContext').useAgentPanelContext;
    ...
    test('VersionContent receives correct props', () => {
        render(<VersionPanel />);
        expect(VersionContent).toHaveBeenCalledWith(expect.objectContaining({
    ...
    test('handles data state variations', () => {
        ...
        render(<VersionPanel />);
        expect(VersionContent).toHaveBeenCalledWith(expect.objectContaining({ selectedAgentId: '' }), expect.anything());
        // Test with null data
        ...
        render(<VersionPanel />);
        expect(VersionContent).toHaveBeenCalledWith(expect.objectContaining({ isLoading: true }), expect.anything());
        // 5. error state
        ...
        render(<VersionPanel />);
        expect(VersionContent).toHaveBeenCalledWith(expect.objectContaining({ error: testError }), expect.anything());
    });
