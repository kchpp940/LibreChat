...
export default function DuplicateAgent({ agent_id }) {
    ...
    return (<Button size="sm" variant="outline" aria-label={localize('com_ui_duplicate_agent')} title={localize('com_ui_duplicate_agent')} type="button" onClick={handleDuplicate}>
