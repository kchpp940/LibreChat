...
describe('ApiKeyDialog', () => {
    const mockUseGetStartupConfig = useGetStartupConfig;
    ...
    it('shows all dropdowns and both reranker fields when no config is set', () => {
        ...
        expect(screen.getByRole('button', { name: 'com_ui_web_search_provider_serper' })).toBeInTheDocument();
        // Scraper dropdown button
        expect(screen.getByRole('button', { name: 'com_ui_web_search_scraper_firecrawl' })).toBeInTheDocument();
        // Reranker dropdown button
        expect(screen.getByRole('button', { name: 'com_ui_web_search_reranker_jina' })).toBeInTheDocument();
