...
const AdminSettings = () => {
    ...
    return (<AdminSettingsDialog permissionType={PermissionTypes.MEMORIES} sectionKey="com_ui_memories" permissions={permissions} menuId="memory-role-dropdown" mutation={mutation}/>);
};
