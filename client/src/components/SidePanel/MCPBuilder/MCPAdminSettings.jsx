...
const MCPAdminSettings = () => {
    ...
    return (<AdminSettingsDialog permissionType={PermissionTypes.MCP_SERVERS} sectionKey="com_ui_mcp_servers" permissions={permissions} menuId="mcp-role-dropdown" mutation={mutation}/>);
};
