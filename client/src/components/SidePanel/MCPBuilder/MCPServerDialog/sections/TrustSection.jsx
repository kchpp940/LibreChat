...
export default function TrustSection() {
    ...
    return (<div className="rounded-lg border border-border-light bg-surface-secondary p-2">
      ...
      {errors.trust && (<p id="trust-error" role="alert" className="mt-2 text-xs text-text-destructive">
