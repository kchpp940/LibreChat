    ...
    return (<div className="space-y-3">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
        ...
        <div className="w-full space-y-1.5 sm:flex-1">
          ...
          <Input id="mcp-title" autoComplete="off" placeholder={localize('com_agents_mcp_name_placeholder')} aria-invalid={errors.title ? 'true' : 'false'} aria-describedby={errors.title ? 'mcp-title-error' : undefined} {...register('title', {
        ...
        pattern: {
          ...
          {errors.title && (<p id="mcp-title-error" role="alert" className="text-xs text-text-destructive">
      ...
      <div className="space-y-1.5">
        ...
        <Textarea id="mcp-description" placeholder={localize('com_agents_mcp_description_placeholder')} {...register('description')}/>
      </div>
    </div>);
}
