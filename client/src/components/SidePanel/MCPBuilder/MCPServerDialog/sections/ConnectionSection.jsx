...
export default function ConnectionSection() {
    ...
    return (<div className="space-y-1.5">
      ...
      <Input id="url" type="url" autoComplete="off" placeholder={localize('com_ui_mcp_server_url_placeholder')} aria-invalid={errors.url ? 'true' : 'false'} aria-describedby={errors.url ? 'url-error' : undefined} {...register('url', {
      ...
      {errors.url && (<p id="url-error" role="alert" className="text-xs text-text-destructive">
          {errors.url.message}
        </p>)}
    </div>);
}
