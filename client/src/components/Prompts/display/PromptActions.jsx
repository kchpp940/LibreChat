...
const PromptActions = ({ group, mainText, onUsePrompt }) => {
    ...
    return (<>
      <div className="flex w-full gap-2 sm:justify-end sm:gap-3">
        ...
        <Button variant="submit" onClick={handleUsePrompt} className="flex-1 gap-2 sm:min-w-40 sm:flex-none" aria-label={localize('com_ui_use_prompt')}>
