...
const PromptDetails = ({ group, showActions = true, onUsePrompt }) => {
    ...
    return (<article className="flex max-h-[80vh] min-w-0 flex-col gap-3 overflow-hidden p-1 sm:gap-4 sm:p-2" aria-label={localize('com_ui_prompt_details', { name: group.name })}>
      ...
      {group.command && (<div className="flex items-center gap-2 rounded-xl border border-border-medium bg-transparent p-3">
