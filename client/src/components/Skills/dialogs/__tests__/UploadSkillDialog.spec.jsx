...
jest.mock('@librechat/client', () => {
    ...
    return {
        OGDialog: ({ open, children }) => open ? React.createElement('div', null, children) : null,
        OGDialogContent: ({ children }) => React.createElement('div', null, children),
