...
const VALID_INVOCATION_MODES = new Set(Object.values(InvocationMode));
/**
...
export function parseSkillMd(raw) {
    ...
    const result = { name: '', description: '', invocationMode: '' };
    for (const { key, value } of fields) {
        ...
        if (lower === 'name') {
            ...
            result.invocationMode = VALID_INVOCATION_MODES.has(value) ? value : '';
        }
    }
    return result;
}
