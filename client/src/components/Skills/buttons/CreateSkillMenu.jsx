...
export default function CreateSkillMenu() {
    ...
    return (<>
      <Dropdown value="" onChange={handleSelect} options={options} className="shrink-0 rounded-lg bg-transparent" icon={<Plus className="size-5"/>} ariaLabel={localize('com_ui_create_skill')} iconOnly/>
