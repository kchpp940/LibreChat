...
const AdminSettings = () => {
    ...
    return (<AdminSettingsDialog permissionType={PermissionTypes.SKILLS} sectionKey="com_ui_skills" permissions={permissions} menuId="skill-role-dropdown" mutation={mutation}/>);
};
