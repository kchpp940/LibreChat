 ...
 */
export default function useShowMarketplace() {
    ...
    const authReady = useMemo(() => authContext?.isAuthenticated !== undefined &&
        (authContext?.isAuthenticated === false || authContext?.user !== undefined), [authContext?.isAuthenticated, authContext?.user]);
