...
const mockInstallCloudFrontImageRetry = jest.fn((_startupConfig, _options) => () => undefined);
const mockGetTokenHeader = jest.fn();
jest.mock('@librechat/client', () => ({
    installCloudFrontImageRetry: (startupConfig, options) => mockInstallCloudFrontImageRetry(startupConfig, options),
}));
...
jest.mock('~/data-provider', () => ({
    useMCPServersQuery: (config) => mockUseMCPServersQuery(config),
    useMCPToolsQuery: (config) => mockUseMCPToolsQuery(config),
}));
