...
export default function useSkillFavorites() {
    ...
    const favorites = useMemo(() => (Array.isArray(getQuery.data) ? getQuery.data : EMPTY_FAVORITES), [getQuery.data]);
