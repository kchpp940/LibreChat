...
`;
        ...
        it('should handle composite citations', () => {
            const text = 'Multiple sources \\ue200\\ue202turn0search0\\ue202turn0news0\\ue202turn0news1\\ue201.';
            const { result } = renderHook(() => useCopyToClipboard({
                text,
                searchResults: mockSearchResults,
            }));
...
`;
    ...
    describe('Citation deduplication', () => {
        it('should use same number for duplicate URLs', () => {
            const mockSearchResultsWithDupes = {
                '0': {
                    organic: [
                        {
...
`;
        ...
        it('should handle multiple citations of the same source', () => {
            ...
            const text = 'First mention \\ue202turn0search0. Second mention \\ue202turn0search0. Third \\ue202turn0search0.';
            const { result } = renderHook(() => useCopyToClipboard({
                text,
                searchResults: mockSearchResults,
            }));
...
`;
    ...
    describe('All citation types', () => {
        ...
        it('should handle all citation types correctly', () => {
            const text = 'Search \\ue202turn0search0, news \\ue202turn0news0, image \\ue202turn0image0, video \\ue202turn0video0, ref \\ue202turn0ref0.';
            const { result } = renderHook(() => useCopyToClipboard({
                text,
                searchResults: mockSearchResults,
            }));
...
`;
    ...
    describe('Complex scenarios', () => {
        it('should handle mixed highlighted text and composite citations', () => {
            ...
            const text = '\\ue203Highlighted text with citation\\ue204 \\ue202turn0search0 and composite \\ue200\\ue202turn0search1\\ue202turn0news0\\ue201.';
            const { result } = renderHook(() => useCopyToClipboard({
                text,
                searchResults: mockSearchResults,
            }));
