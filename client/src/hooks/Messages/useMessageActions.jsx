...
import { getTagByKey, isAgentsEndpoint, toMinimalFeedback, isAssistantsEndpoint, } from 'librechat-data-provider';
...
export default function useMessageActions(props) {
    ...
    const { ask, index, regenerate, conversation, latestMessageId, latestMessageDepth, handleContinue,
    ...
    const feedbackMutation = useUpdateFeedbackMutation(conversation?.conversationId || '', message?.messageId || '');
    const handleFeedback = useCallback(({ feedback: newFeedback }) => {
        const payload = {
