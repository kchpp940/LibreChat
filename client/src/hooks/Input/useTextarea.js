...
import { forceResize, insertTextAtCursor, getEntityName, getEntity, checkIfScrollable, } from '~/utils';
...
export default function useTextarea({ textAreaRef, submitButtonRef, setIsScrollable, disabled = false, placeholder, }) {
    ...
    const isNotAppendable = latestMessage?.error === true && latestMessage.isCreatedByUser === true && !isAssistant;
