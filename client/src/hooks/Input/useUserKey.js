...
const useUserKey = (endpoint) => {
    ...
    const saveUserKey = useCallback((userKey, expiresAt) => {
    ...
    return useMemo(() => ({ getExpiry, checkExpiry, saveUserKey }), [getExpiry, checkExpiry, saveUserKey]);
};
