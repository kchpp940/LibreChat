 ...
 */
export const useInfiniteScroll = ({ hasNextPage = false, isLoading = false, fetchNextPage, threshold = 0.8, // Trigger when 80% scrolled
throttleMs = 200, }) => {
    ...
    const throttledHandleNeedToFetch = useMemo(() => throttle(handleNeedToFetch, throttleMs), [handleNeedToFetch, throttleMs]);
