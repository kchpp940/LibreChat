 ...
 */
export default function useAdaptiveSSE(submission, chatHelpers, isAddedRequest = false, runIndex = 0) {
    ...
    const { streamId } = useResumableSSE(resumableEnabled ? submission : null, chatHelpers, isAddedRequest, runIndex);
