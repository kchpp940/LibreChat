...
import { ActivePanelProvider, resolveActivePanel, useActivePanel, } from '~/Providers/ActivePanelContext';
...
describe('ActivePanelContext', () => {
    ...
    it('throws when useActivePanel is called outside provider', () => {
        ...
        expect(() => render(<TestConsumer />)).toThrow('useActivePanel must be used within an ActivePanelProvider');
        spy.mockRestore();
    });
});
