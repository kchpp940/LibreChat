...
export function DragDropProvider({ children }) {
    ...
    const endpointType = useMemo(() => resolveEndpointType(endpointsConfig, conversation?.endpoint, agentProvider), [endpointsConfig, conversation?.endpoint, agentProvider]);
