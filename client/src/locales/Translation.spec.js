import { __resetLocaleForTests, __setLocaleLoaderForTests, changeLanguageSafely, ensureLocale, initializeI18n, normalizeLocale, } from './i18n';
...
describe('i18next translation tests', () => {
    ...
    it('should only apply the newest rapid language switch', async () => {
        ...
        const svLocale = deferred();
        const kaLocale = deferred();
        const slLocale = deferred();
